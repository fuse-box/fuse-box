...
export class ImportEventTest {
    RegisterEventAfterImport(done) {
        createEnv({
            ...
            result.project.FuseBox.on("after-import", (exports, require, define, module, __filename, __dirname, pkg) => {
    ...
    registerBeforeImport(done) {
        createEnv({
            ...
            let results = [];
            result.project.FuseBox.on("before-import", (exports, require, define, module, __filename, __dirname, pkg) => {
