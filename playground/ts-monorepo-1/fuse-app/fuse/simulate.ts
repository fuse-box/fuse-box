...
export function runUpdateSimulation(enable: boolean) {
    ...
    function triggerWatcher() {
        ...
        writeFile(triggerFile, `export const count = ${number}; // auto generated by ${__filename}, you can have this periodically incremented from there by uncommenting a line`, () => {
            if (enable)
                setTimeout(triggerWatcher, 5000);
        });
    }
    triggerWatcher();
